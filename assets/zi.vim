...
" Common colors
let s:blue   = [ '#61afef', 12 ]
let s:green  = [ '#98c379', 10 ]
let s:purple = [ '#c678dd', 13 ]
let s:red1   = [ '#e06c75', 1 ]
let s:red2   = [ '#be5046', 9 ]
let s:yellow = [ '#e5c07b', 11 ]
...
if lightline#colorscheme#background() ==# 'light'
  ...
  let s:fg    = [ '#abb2bf', 145 ]
  let s:bg    = [ '#282c34', 0 ]
  let s:gray1 = [ '#5c6370', 8 ]
  let s:gray2 = [ '#2c323d', 8 ]
  let s:gray3 = [ '#3e4452', 0 ]
...
let g:lightline#colorscheme#zi#palette = lightline#colorscheme#flatten(s:p)
